...
public class Stack {
     ...
     * contatore non aumenta, altrimenti si.
     * In  caso non avesse carte istantanee in mano il contatore aumenterà 
     * automaticamente e si invertono i turni per l'inserimento nello stack di 
     * una carta
     * @param currentPlayer
